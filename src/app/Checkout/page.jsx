...
export default function Checkout() {
  ...
  return (
    <>
      <div className="bg-gradient-to-tl from-blue-400 to-orange-300">
        <Header />
        <div className="flex flex-col justify-center items-center my-5 w-full">
          ...
          <div className="w-8/12 mt-5 h-0.5 rounded-full bg-gray-100"></div>
        </div>
            ...
            <div className="flex flex-col h-96 w-2/4">
              <div className="flex p-2 flex-col w-full">
                <h1
                  ...
                  className="text-xl text-white mt-4 font-bold"
                >
                  Your Address
                </h1>
              </div>
              <div className="w-full mt-2 rounded-lg p-6 bg-gray-100 flex flex-col items-center">
                <div className="flex gap-4 w-full">
                  <div className="w-2/4">
                    ...
                    <input
                      ...
                      className="w-full px-3 h-9 mb-1 text-sm border bg-gray-100 shadow-[0px_1px_3px_#bab6b5] bg-transparent focus:outline-none focus:ring-blue-900 focus:ring-1 rounded-md"
                    />
                  </div>
                  <div className="w-2/4">
          ...
          <div className="flex flex-col w-7/12 h-auto">
            <div className="flex w-full">
              <div className="flex p-2 flex-col w-full">
                ...
                <div className="flex p-6 flex-col bg-gray-100 shadow-[0px_2px_5px_#bab6b5] rounded-lg">
              ...
              <div className="flex w-full">
                <div className="flex p-2 flex-col w-full">
                  ...
                  <div className="flex p-6 flex-col bg-white shadow-[0px_2px_10px_#bab6b5] rounded-lg">
                    ...
                    <Link
                      className="flex text-sm hover:px-8 px-5 py-2 text-white self-center bg-blue-900 ease-in-out duration-300 hover:bg-orange-400 active:bg-blue-900 justify-center rounded-full items-center"
                      href="/OrderDetail"
                    >
