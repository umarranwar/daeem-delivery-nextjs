    ...
    <div className="">
      <div className="pt-5">
        <div className="flex mx-5 justify-between">
          <h1 className="font-bold text-xl text-gray-600">Electronics</h1>
          <div className="flex gap-10">
            <button>
              <FaArrowLeftLong
                onClick={slideLeft02}
                className="size-6 text-gray-600 z-50"
              />
            </button>
            <button>
              <FaArrowRightLong
          ...
          >
            <div className="flex mx-5 my-3 gap-3">
              {electronics.map((item, index) => (
                <div
                  key={index}
                  className="flex relative p-3 z-0 flex-col group hover:shadow-orange-400 hover:border-gray-700 bg-white rounded-xl border border-gray-300 w-52"
                >
                  <div className="flex flex-col z-10 justify-between p-2 bg-slate-100 rounded-lg h-60 w-full">
                    <div className="bg-white z-10 opacity-90 absolute right-4 top-4 cursor-pointer rounded-full p-1.5">
                      <BiHeart className="size-6 text-gray-700" />
                    </div>
                    <div className="flex relative w-full items-center justify-center h-full">
                      ...
                      <div className="absolute bottom-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <button className="absolute bottom-0 right-0">
                          <FaCartPlus className="size-8 text-orange-400" />
                        </button>
                      </div>
                    </div>
                  </div>
                  <div className="flex w-full gap-3 justify-between text-gray-600 text-sm mt-5 flex-col">
                    <div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <p className="text-orange-400 text-xs font-bold">13%</p>
                    </div>
                  </div>
                </div>
              ))}
