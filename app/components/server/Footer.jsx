...
function Footer() {
  return (
    <div className="flex p-10 duration-300 mt-10 justify-between hover:opacity-100 flex-wrap opacity-90 flex-row bg-gradient-to-tr from-orange-300 to-orange-200  text-white">
