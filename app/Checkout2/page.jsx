    ...
    <>
      <div>
        ...
        <div className="flex gap-5 pb-10 text-blue-900 px-36">
          {isLogin ? (
            <div className="flex flex-col h-96 w-6/12">
          ...
          <div className="flex flex-col w-4/12 h-auto">
            ...
            <div className="flex p-5 flex-col border rounded-lg w-full h-auto">
              <h1>Order Summary</h1>
              <div className="flex mt-8 m-3 gap-5">
                <div className="w-14 bg-black h-14">image</div>
                <div className="flex justify-center text-sm flex-col">
                  <h1>food name</h1>
                  <p className="text-xs">1 x SAR 10</p>
                </div>
              </div>
              ...
              <ditv className="flex text-gray-800 justify-between">
